...
public class ManagerTollStation extends User implements Manager {

	public ManagerTollStation(String name, String lastName, String email, String password, Gender gender, String phoneNum, Address address, Role role) {
